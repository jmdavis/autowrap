...
.PHONY: clean test test_simple_pyd test_simple_pynih test_simple_cs test_issues test_pyd test_numpy examples/simple/lib/pyd/libsimple.so examples/simple/lib/pynih/libsimple.so examples/simple/lib/csharp/libsimple.so examples/simple/lib/csharp/libsimple.x64.so examples/issues/libissues.so examples/pyd/libpydtests.so examples/numpy/libnumpy.so
